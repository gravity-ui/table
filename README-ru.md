...
Для использования выбора строки вместе с группировкой не забудьте вызвать утилиту `getFixedRowSelection`. Без него стейт строки-родителя будет вычисляться неправильно. https://github.com/TanStack/table/issues/4878
...
Для использования выбора строки вместе с группировкой не забудьте вызвать хук `getFixedRowSelection`. Без него стейт строки-родителя будет вычисляться неправильно. https://github.com/TanStack/table/issues/4878
